...
public class MyWebserviceServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.MyWebserviceService {
    ...
    public DefaultNamespace.MyWebservice getMyWebservice() throws javax.xml.rpc.ServiceException {
    ...
    public DefaultNamespace.MyWebservice getMyWebservice(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.MyWebserviceSoapBindingStub _stub = new DefaultNamespace.MyWebserviceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.MyWebservice.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.MyWebserviceSoapBindingStub _stub = new DefaultNamespace.MyWebserviceSoapBindingStub(new java.net.URL(MyWebservice_address), this);
                _stub.setPortName(getMyWebserviceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "MyWebserviceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "MyWebservice"));
        }
